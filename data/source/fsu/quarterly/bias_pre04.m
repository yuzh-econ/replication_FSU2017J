...
load est_pre04.mat vF vETA TT country_name tt
...
hx = vF(:,:,i);
ETA = vETA(:,:,i);
b(i,1:nv-np) =  bias_est(hx,ETA,TT(i),156,np, Tmontecarlo);
disp(i);
disp(b(i,:));
...
load bias_pre04.mat
%produced by running the present  program (bias_pre04.m)
load est_pre04.mat result
%produced  with est_pre04.m
