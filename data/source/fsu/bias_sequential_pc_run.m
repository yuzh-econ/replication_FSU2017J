...
load est_sequential_pc.mat vF vETA TT country_name
%produced by running est_sequential_pc.m
...
nv = 2; %total number of variables in the SVAR, 4 world prices (3 commodities and the world interest rate) plus 1 NIPA. 
np = 1; %total number of world prices in the SVAR. 
...
save bias_sequential_pc_run.mat
...
load bias_sequential_pc_run.mat
%produced by running the present  program (bias_sequential_pc_run.m)
load est_sequential_pc.mat result
%produced  with est_sequential_pc.m
